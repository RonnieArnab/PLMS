...
export function MyLoans() {
  ...
  const handleDownload = (loan) => {
    ...
    doc.setFont("helvetica", "normal");
    doc.text(
      "This is a system-generated loan detail report.",
      105,
      footerY + 8,
      { align: "center" }
    );
    doc.text("For assistance, contact support@proloan.com", 105, footerY + 15, {
      align: "center",
    });
  ...
  const exportToCSV = () => {
    ...
    try {
      ...
      if (link.download !== undefined) {
        ...
        link.setAttribute(
          "download",
          `my_loans_${new Date().toISOString().split("T")[0]}.csv`
        );
  ...
  const handlePay = (loan) => {
    ...
    navigate(
      `/payments?loan=${loan.id}&amount=${
        loan.monthlyPayment || loan.remainingBalance
      }&dueDate=${loan.nextPaymentDate || ""}&product=${encodeURIComponent(
        loan.productName || ""
      )}`
    );
  };
              ...
              <table className="table-auto w-full text-sm text-left border-collapse border border-gray-300">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="border border-gray-300 px-4 py-2">
                      {selectedLoan.approvedAmount != null
                        ? `₹${inr(selectedLoan.approvedAmount)}`
                        : "-"}
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td className="border border-gray-300 px-4 py-2">
                      {selectedLoan.completionDate
                        ...
                        ? new Date(selectedLoan.closedDate).toLocaleDateString()
                        : "-"}
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td className="border border-gray-300 px-4 py-2">
                      ₹{inr(selectedLoan.monthlyPayment)}
                    </td>
                  </tr>
                  <tr>
                    <th className="border border-gray-300 px-4 py-2">
                  ...
                  <tr>
                    ...
                    <td className="border border-gray-300 px-4 py-2">
                      ₹{inr(selectedLoan.remainingBalance)}
                    </td>
                  </tr>
                  <tr>
                    <th className="border border-gray-300 px-4 py-2">
